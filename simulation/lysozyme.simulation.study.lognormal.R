...
##############################################
simulation_settings_df <- expand.grid(A2=A2_vec, num_experiments = num_experiments_vec, sc = sc_vec, priors = priors_vec)
##############################################
# model specification
...
#
write.model(lysozyme_model, "./simulation/lysozyme_sim_model.bug")
##
...
for(i in 1:nrow(simulation_settings_df)){
  ...
  out <-  jags(data=dat_jags, inits=jags.inits, 
                      ...
                      n.thin = thin, 
                      digits = 16, 
                      model.file="./simulation/lysozyme_sim_model.bug")
...
# setwd("/Users/fan/Documents/UCI/Research/light_scattering_new/lysozyme/")
# simulation_summary <- readRDS("/Users/fan/Documents/UCI/Research/light_scattering_new/lysozyme/simulation_summary_log_normal.rds")
#######
# simulation_summary <- mutate(simulation_summary, con_error = exp(sc*1.96)-1)
saveRDS(simulation_summary, "./simulation/simulation_summary_log_normal.rds")
