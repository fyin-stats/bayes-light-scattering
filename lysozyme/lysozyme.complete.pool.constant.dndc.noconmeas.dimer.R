...
#
write.model(lysozyme_model, "./lysozyme/lysozyme_model_dimer_log_normal.bug")
############################
time1 <- Sys.time()
...
out <- do.call(jags.parallel, 
               list(data=dat_jags, inits=jags.inits, 
                    ...
                    n.thin = thin, 
                    digits = 16, 
                    model.file="./lysozyme/lysozyme_model_dimer_log_normal.bug"))
...
time2 <- Sys.time()
####
saveRDS(out, "./lysozyme/lysozyme_complete_pool_constant_dndc_noconmeas_log_normal_loose_prior_dimer.rds")
